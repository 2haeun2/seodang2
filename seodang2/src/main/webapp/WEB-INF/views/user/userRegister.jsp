...
<script type="text/javascript">
	...
	<h2>회원 가입</h2>
	<form:form modelAttribute="userVO" action="registerUser.do" id="register_form">
		...
		<ul>
			...
			<li>
				...
				<form:input path="id" placeholder="영문,숫자만 허용"/>
			...
			<li>
				...
				<form:input path="zipcode" onclick="sample2_execDaumPostcode()"/>
