...
<div class="cartList_div">
   ...
   <c:if test="${empty list}" >
   	<table class="cartList_table">
   		<tr>
   		<th style="background-color:#d8f0f2; color:black">장바구니</th>
   		</tr>
   	</table>	
...
<table class="cartList_table">
   <tr>	
   <th colspan="6" style="background-color:#d8f0f2; color:black">장바구니</th>
   </tr>
   ...
   <c:forEach var="cart" items="${list}">
   	...
   	<table style="padding:30px 0">
   	  <tr>
      <td style="background-color:#d8f0f2; color:red;">
         <fmt:formatNumber value="${total }" pattern="#,###" /> 원
      </td>
      <td style="background-color:#d8f0f2; color:red;">
      	<input type="submit" value="구매하기" class="cart-btn">
      </td>
      </tr>
    </table>   
</form>
