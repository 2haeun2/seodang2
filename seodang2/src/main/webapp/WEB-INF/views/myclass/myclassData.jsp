				...
				<tbody>
					...
					<tr>
						...
						<td>
							<c:choose>
							<c:when test="${myclass.on_status == 1}">
							<button class="btn btn-danger btn-sm" onclick="location.href='myclassDelete.do?onreg_num=${myclass.onreg_num}&on_num=${myclass.on_num}&user_num=${myclass.user_num}'">강의 취소</button>
							</c:when>
							<c:when test="${myclass.on_status == 2}">
