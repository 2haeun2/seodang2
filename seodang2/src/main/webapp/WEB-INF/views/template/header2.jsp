	...
	<div class="mainpage">
		<div class="flexdisplay">
			...
			<div class="search-form display-flex">
				<div class="search-item">취미를 검색하세요</div>
				<span class="search-item"><img src="${pageContext.request.contextPath}/resources/images/magnifier.png"></span>
			</div>
			...
			<div class="login align-right">
				...
				<c:if test="${!empty session_user_num }">
					...
					<a href="${pageContext.request.contextPath}/user/myMenu.do">마이클래스</a>
